  ...
  return (
    ...
    >
      <div className="relative w-5 h-5">
        {theme === "dark" ? (
          <svg
            className="w-5 h-5 text-amber-300 transition-transform duration-300 group-hover:rotate-180"
            fill="currentColor"
            viewBox="0 0 20 20"
          >
          ...
          <svg
            className="w-5 h-5 text-indigo-600 transition-transform duration-300 group-hover:-rotate-12"
            fill="currentColor"
            viewBox="0 0 20 20"
          >
